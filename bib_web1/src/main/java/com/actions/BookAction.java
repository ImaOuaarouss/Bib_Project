...
public class BookAction extends BaseAction {
	...
	@Action(value = "", results = { @Result(name = "success",type="redirect", location = "listAction"),
	 ...
	 * @return
	 */
	@Action(value = "showFormAdd", results = { @Result(name = "saveform", location = "form.jsp"),
			@Result(name = "error", location = "error.jsp" )}) 
